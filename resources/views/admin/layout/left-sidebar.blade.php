        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="ui-features" data-parent="#accordionExample">
                    <li>
                        <a href="{{ route('career.create') }}"> Add Career</a>
                    </li>

                    <li>
                        <a href="{{ route('career.index') }}"> All Careers</a>
                    </li>
                    <li>
                        <a href="{{ route('career.requests') }}"> Career Requests </a>
                    </li>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="orders" data-parent="#accordionExample">
                    ...
                    <li>
                        <a href="{{ route('all_orders') }}"> All Orders</a>
                    </li>
                    <!-- <li>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="contactreq" data-parent="#accordionExample">
                    ...
                    <li>
                        <a href="{{ route('contact_requests') }}"> All Requests</a>
                    </li>
                    <!-- <li>
                        <a href="#"> Inactive Careers </a>
                    </li> -->
