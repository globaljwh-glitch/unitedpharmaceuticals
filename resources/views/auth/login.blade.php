...
<head>
    ...
    <title>United Pharmaceuticals Inc.</title>
    ...
    <form method="POST" action="{{ route('login') }}" class="form-login">
        ...
        <div class="row">
            <div class="col-md-12 text-center mb-4">
                <img alt="logo" src="{{ asset('images/logo-upi.png')}}" class="theme-logo">
            </div>
            @if($errors->all())
            ...
            <div class="col-md-12">
                ...
                <input type="email" id="inputEmail"
                    class="form-control mb-4 {{ $errors->has('email') ? ' is-invalid' : '' }}" placeholder="email"
                ...
                <input type="password" id="inputPassword"
                    class="form-control mb-5{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password"
