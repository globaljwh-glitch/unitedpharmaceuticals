        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-11 m-auto text-center">
                    <h2>Contact Us</h2>
                    <p class="mb-0">
                        We appreciate the opportunity to demonstrate why United Pharmaceuticals Inc. is the right partner
                        for your business.
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" value=""  placeholder="Enter your street address" name="address">
                                            </div>
                                        </div>
